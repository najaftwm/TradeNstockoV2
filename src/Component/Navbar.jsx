...
export default function Navbar() {
  ...
  console.log("isOpen:", isOpen); // Debug: Check state toggle
  ...
  return (
    <nav className="fixed top-7 z-50 bg-[#1E4A44] shadow-xl border-gray-300 rounded-xl max-w-7xl mx-auto left-0 right-0 px-6">
      <div className="flex items-center justify-between py-4">
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden text-[#F8F1E9] focus:outline-none p-2 bg-[#2A4D44] rounded-full z-60" // Increased z-index to 60
        >
      ...
      <div
        ...
        } transition-transform duration-300 ease-in-out z-10`} // Lowered z-index to 10
      >
